{*
  Constantes pour la compilation d'unité unité FunDelphi en Sepi
  @author sjrd
  @version 5.0
*}
unit SepiFunDelphiCompilerConsts;

interface

resourcestring
  SClassOfRequired = 'Sous-classe de %s requise';
  SInvalidPropertyType = '%s n''est pas un type valide pour une propriété';
