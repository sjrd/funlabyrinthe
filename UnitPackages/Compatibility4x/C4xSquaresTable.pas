...
const
  SquaresTable: array[#33..#255] of string = (
    ...
    '',
    '',
    'UnderBoat.Water--Boat1-',
    'UnderBoat.Water--Boat2-',
    'UnderBoat.Water--Boat3-',
    'UnderBoat.Water--Boat4-',
    'UnderBoat.Water--Boat5-',
    'UnderBoat.Water--Boat6-',
    'UnderBoat.Water--Boat7-',
    'UnderBoat.Water--Boat8-',
    'UnderBoat.Water--Boat9-',
    'UnderBoat.Water--Boat10-',
    '',
    '',
    '',
    '',
